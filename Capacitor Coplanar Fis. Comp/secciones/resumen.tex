...
\textit{\small{\ut{Abstract: The capacitance of a coplanar capacitor with electrodes based on a second-order Hilbert pseudo-curve was characterized using the modified relaxation method employing fourth-order centered finite differences, with a tolerance of $1 \times 10^{-12}$. Furthermore, the behavior of the electric field, potential, and charge is presented. }}}
\small{ }
